...
@Service
public class Litecoin implements BlockIoCryptoProviderCt {
    ...
    public String getRandomAddress(double expectedAmount) {
        ...
        final String EndPoint = prop.BLOCKIO_BASE_URL + "get_new_address/?api_key="+prop.CRYPT_API_KEY_LTC;
        ...
        try {
            ...
            cryptoProviderAddress.setCurrency(Currency.LTC);
    ...
    public Double getBalance(String address) {
        final String EndPoint = prop.BLOCKIO_BASE_URL + "get_address_balance/?api_key="+prop.CRYPT_API_KEY_LTC+"&addresses="+address;
